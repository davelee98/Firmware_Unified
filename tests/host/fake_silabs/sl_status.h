...
/* Distinct placeholders, not the SDK's numbering: every comparison in the code under test is
 * symbolic, so only distinctness matters. */
...
#define SL_STATUS_NOT_INITIALIZED   ((sl_status_t)6u)
